...
export default function LicensesCertificationsPanel({ documentsBySection, selectedBySection, onToggle, onToggleAll, onUpload, onPreview, onEdit, onDownload, onDelete, onDownloadSelected, onDeleteSelected }) {
  return (
